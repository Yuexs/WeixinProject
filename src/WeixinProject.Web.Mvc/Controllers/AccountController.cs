...
using WeixinProject.Web.Models.Account;
using WeixinProject.Web.Views.Shared.Components.TenantChange;

namespace WeixinProject.Web.Controllers
{
    public class AccountController : WeixinProjectControllerBase
    {
